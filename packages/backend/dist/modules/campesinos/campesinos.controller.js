...
let CampesinosController = class CampesinosController {
    ...
    create(req, createCampesinDto) {
        return this.campesinosService.create(createCampesinDto, req.user?.id);
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_campesino_dto_1.CreateCampesinDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_campesino_dto_1.UpdateCampesinDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Guardar imagen de perfil del campesino' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, save_profile_image_dto_1.SaveCampesinoProfileImageDto]),
    __metadata("design:returntype", void 0)
], CampesinosController.prototype, "saveProfileImage", null);
__decorate([
    (0, common_1.Get)(':id/foto-perfil'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener imagen de perfil del campesino' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Eliminar imagen de perfil del campesino' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
