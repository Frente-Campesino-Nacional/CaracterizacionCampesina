...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'admin@censo.com' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'encuestador', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(['admin', 'administrador', 'encuestador']),
    __metadata("design:type", String)
