...
export class CampesinosController {
  ...
  findAll(@Request() req, @Query('consejoId') consejoId?: string) {
  ...
  create(@Request() req, @Body() createCampesinDto: CreateCampesinDto) {
    return this.campesinosService.create(createCampesinDto, req.user?.id);
  }

  @Put(':id')
  @ApiOperation({ summary: 'Actualizar campesino' })
  update(@Param('id') id: string, @Body() updateCampesinDto: UpdateCampesinDto) {
  ...
  @Post(':id/foto-perfil')
  @ApiOperation({ summary: 'Guardar imagen de perfil del campesino' })
  saveProfileImage(
    @Param('id') id: string,
  ...
  @Get(':id/foto-perfil')
  @ApiOperation({ summary: 'Obtener imagen de perfil del campesino' })
  getProfileImage(@Param('id') id: string) {
    return this.campesinosService.getProfileImage(id);
  }

  @Delete(':id/foto-perfil')
  @ApiOperation({ summary: 'Eliminar imagen de perfil del campesino' })
